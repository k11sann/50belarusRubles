...
class Paths
{
	...
	inline static public function txtSprays(key:String, ?library:String)
	{
		return getPath('images/tvorog/sprayPart/Presets/$key.txt', TEXT, library);
	}
	...
	inline static public function jsonSprays(key:String, ?library:String)
	{
		return getPath('images/tvorog/sprayPart/Presets/$key.json', TEXT, library);
	}
